...
export const IoTAndESimPage: React.FC<IoTAndESimPageProps> = ({ onConnect }) => {
    return (
        <div className="pt-20 bg-brand-dark min-h-screen animate-fade-in text-brand-text-primary">
            {/* 1. Hero Section */}
            <section className="relative py-24 leading-relaxed overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        <span className="text-brand-accent font-semibold tracking-wider uppercase text-sm mb-4 block">Simp Tri-SIM</span>
                        <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight">
                            One SIM Card. <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-accent to-orange-400">Total Adaptability.</span>
                        </h1>
                    ...
                    <div className="relative flex justify-center">
                        {/* Sim Card Visualization */}
                        <div className="w-80 h-52 bg-gradient-to-br from-brand-surface to-brand-dark rounded-2xl border border-brand-accent/50 shadow-2xl relative overflow-hidden flex flex-col justify-between p-6 transform hover:rotate-1 transition-transform duration-500">
                        ...
                        <div className="bg-brand-dark p-8 rounded-xl border border-brand-border shadow-lg flex flex-col">
                            <div className="w-12 h-12 bg-brand-surface rounded-lg flex items-center justify-center mb-6 border border-brand-border">
                                <div className="text-brand-primary">
                                    {/* Using a generic icon for wifi/provisioning since Wifi was not imported in original snippet but used. I will import it if needed, or use Globe. Let's start with Globe for now or add Wifi to imports. Wait, Wifi IS imported in my new replacement content. */}
