                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        <h1 className="text-4xl lg:text-6xl font-bold mb-6 leading-tight">
                            Simtope Satellite: <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-brand-accent">Beyond the Edge</span>
                        </h1>
                        <p className="text-xl text-brand-text-secondary mb-8 leading-relaxed">
                            Stay connected where cellular networks end. Our converged satellite solution provides truly global coverage for mission-critical IoT assets, eliminating blind spots and ensuring continuous data flow.
                        </p>
                        <div className="flex flex-wrap gap-4">
                            <Button size="lg">Talk to a Satellite Expert</Button>
                        </div>
                    </div>

                    <div className="flex justify-center relative">
                        <div className="relative w-full max-w-md aspect-square bg-brand-surface/30 rounded-full border border-brand-primary/20 flex items-center justify-center backdrop-blur-sm">
