...
export const SatellitePage: React.FC = () => {
    return (
        <div className="pt-20 bg-brand-dark min-h-screen animate-fade-in">
            ...
            <section className="relative py-20 lg:py-32 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        <h1 className="text-4xl lg:text-6xl font-bold text-brand-text-primary mb-6 leading-tight">
                            Introducing <br />
                        ...
                        <div className="flex items-center gap-4 text-brand-text-secondary font-medium">
                            ...
                            <span className="text-brand-text-primary font-bold text-lg flex items-center gap-2">
                                <Satellite className="w-5 h-5 text-brand-accent" /> Satellite Partner
                            </span>
                        </div>
                    </div>
                    <div className="flex justify-center relative">
                        ...
                        <div className="relative z-10 w-full max-w-md">
                            {/* Abstract Visualization of Satellite + SIM */}
