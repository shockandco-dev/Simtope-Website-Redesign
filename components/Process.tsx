...
import { Hammer, Rocket, Settings, TrendingUp, ArrowRight } from 'lucide-react';
          ...
          {steps.map((step, index) => (
            <div key={index} className="flex flex-col items-center text-center group">
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <ArrowRight className="w-5 h-5 text-brand-text-secondary group-hover:text-amber-500 group-hover:translate-x-1 transition-all" />
              </div>
